      ...
      {!selectedPeriodId ? (
        <div className="bg-zinc-900/60 p-12 rounded-2xl border border-dashed border-zinc-800 text-center">
          ...
          <p className="text-zinc-400 font-medium max-w-md mx-auto">
            Please choose an Enrollment Period from the dropdown above to load your timeslots and interactive availability calendar.
          </p>
        </div>
      ) : (
        <>
          ...
          <div className="bg-zinc-900 p-6 rounded-2xl shadow-xl border border-zinc-800">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {rooms.length === 0 && <span className="text-sm font-semibold text-amber-400">No rooms available. Contact Admin to add studio rooms first.</span>}
            </div>
          </div>
